...
describe('GetActionsService', () => {
  ...
  it('reach the nearest reachable protein', () => {
    ...
    const actions = service.execute(turnInfo);
    expect(actions).toHaveLength(1);
    const firstDestination = new Position(3, 1);
    ...
    const secondDestination = new Position(2, 1);
    ...
    const thirdDestination = new Position(2, 2);
    ...
    const fourthDestination = new Position(2, 3);
